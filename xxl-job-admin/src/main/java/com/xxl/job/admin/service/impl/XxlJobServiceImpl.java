...
public class XxlJobServiceImpl implements XxlJobService {
  ...
  public Map<String, Object> pageList(int start, int length, int jobGroup, int triggerStatus,
    ...
    // page list
    List<XxlJobInfo> list = xxlJobInfoDao.pageList(start, length, jobGroup, triggerStatus, jobDesc,
        executorHandler, author);
    int list_count = xxlJobInfoDao.pageListCount(start, length, jobGroup, triggerStatus, jobDesc,
        executorHandler, author);
  ...
  public Response<String> add(XxlJobInfo jobInfo) {
    ...
    if (group == null) {
      return new Response<String>(Response.FAIL_CODE,
          (I18nUtil.getString("system_please_choose") + I18nUtil.getString(
              "jobinfo_field_jobgroup")));
    }
    if (jobInfo.getJobDesc() == null || jobInfo.getJobDesc().trim().length() == 0) {
      return new Response<String>(Response.FAIL_CODE,
          (I18nUtil.getString("system_please_input") + I18nUtil.getString(
    ...
    if (scheduleTypeEnum == ScheduleTypeEnum.CRON) {
      if (jobInfo.getScheduleConf() == null || !CronExpression.isValidExpression(
      ...
      if (jobInfo.getScheduleConf() == null) {
        return new Response<String>(Response.FAIL_CODE, (I18nUtil.getString("schedule_type")));
      }
      try {
    ...
    if (ExecutorRouteStrategyEnum.match(jobInfo.getExecutorRouteStrategy(), null) == null) {
      return new Response<String>(Response.FAIL_CODE,
          (I18nUtil.getString("jobinfo_field_executorRouteStrategy") + I18nUtil.getString(
              "system_unvalid")));
    }
    ...
    if (ExecutorBlockStrategyEnum.match(jobInfo.getExecutorBlockStrategy(), null) == null) {
      return new Response<String>(Response.FAIL_CODE,
          (I18nUtil.getString("jobinfo_field_executorBlockStrategy") + I18nUtil.getString(
              "system_unvalid")));
    }
          ...
          if (childJobInfo == null) {
            return new Response<String>(Response.FAIL_CODE,
                MessageFormat.format(
                    (I18nUtil.getString("jobinfo_field_childJobId") + "({0})" + I18nUtil.getString(
                        "system_not_found")), childJobIdItem));
          }
        } else {
          return new Response<String>(Response.FAIL_CODE,
              MessageFormat.format(
                  (I18nUtil.getString("jobinfo_field_childJobId") + "({0})" + I18nUtil.getString(
                      "system_unvalid")), childJobIdItem));
        }
      }
    ...
    return new Response<String>(String.valueOf(jobInfo.getId()));
  }
  ...
  public Response<String> update(XxlJobInfo jobInfo) {
    ...
    boolean scheduleDataNotChanged =
        jobInfo.getScheduleType().equals(exists_jobInfo.getScheduleType())
  ...
  public Response<String> start(int id) {
    ...
    // valid
    ScheduleTypeEnum scheduleTypeEnum = ScheduleTypeEnum.match(xxlJobInfo.getScheduleType(),
  ...
  @Override
  public Response<String> stop(int id) {
    XxlJobInfo xxlJobInfo = xxlJobInfoDao.loadById(id);
